...
import com.example.myapp.R.id.learn_word
import com.example.myapp.databinding.ActivityLearnWordBinding

class MainActivity : AppCompatActivity() {
    private var _binding: ActivityLearnWordBinding? = null
    private val binding
        get() = _binding
            ?: throw IllegalStateException("Binging for ActiveLearningWordBinding must not be null")
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setOnApplyWindowInsetsListener(findViewById(learn_word)) { v, insets ->
